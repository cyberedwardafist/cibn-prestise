/* =============================================================================
   ...
   Metadata builder (bukan bagian skor — mesin skor TIDAK membacanya):
     mode:   'listening'|'structure'|'reading'|'full'
     timers: { listening, structure, reading }  // DETIK, hanya ada di mode 'full'.
             // Timer total soal (kolom timer_jam/menit/detik) = jumlah ketiganya,
             // dihitung otomatis oleh builder (admin/soal/soal.js). Nilai awal =
             // durasi resmi TOEFL ITP (35 / 25 / 55 menit = 1j 55m). Soal Full lama
             // tanpa `timers` tetap valid — cuma punya 1 timer total.
